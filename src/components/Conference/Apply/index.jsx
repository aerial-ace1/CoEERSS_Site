...
export const Apply = () => (
  <div>
    ...
    <b>Personal Reason</b>
    <br />
    The ISERDM cannot refund or pay any compensation where could not
    attend the conference is prevented by reason of circumstances which amount to “personal reason”.
    Such as travel difficulties, visa problems, health issues, financial default etc.
  </div>
);
